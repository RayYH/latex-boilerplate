...
% dtvs
\newcommand{\dtvs}{\vspace*{-12mm}}
% red italic text
\def \rit #1{\textit{\textcolor{red}{#1}}}
% italic bold
\newcommand{\dib}[1]{\textit{\textbf{#1}}}
% inline code
\newcommand{\dic}{\mintinline}
% used in examples of system calls table
\newcommand{\dmct}[1]{\multicolumn{1}{l}{\texttt{#1}}}
% red italic
\def \dri #1{\textit{\textcolor{red}{#1}}}
% emphasize
\newcommand{\dem}[1]{\textcolor{dnote}{#1}}
% emacs keys
\newcommand{\ek}[1]{\textcolor{dnote}{\texttt{#1}}}
% emacs commands
\newcommand{\emc}[1]{\textcolor{dattention}{\texttt{#1}}}
% emacs variables
\newcommand{\emv}[1]{\textcolor{dcaution}{\texttt{#1}}}
% float right
\newcommand{\dfr}[1]{\null\hfill {#1}}
% admonitions
...
\newcommand{\wlitem}[1]{
    \item \textcolor{dgray}{#1}
}
% column one vertical center
